...
public class MealTestData {
    ...
    public static final MealTo MEAL_TO1 = MealsUtil.createTo(MEAL1, false);
    public static final MealTo MEAL_TO2 = MealsUtil.createTo(MEAL2, false);
    public static final MealTo MEAL_TO3 = MealsUtil.createTo(MEAL3, false);

    public static final List<Meal> MEALS = List.of(MEAL7, MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);

    public static final List<MealTo> MEALS_TO = MealsUtil.getTos(MEALS, 2000);
