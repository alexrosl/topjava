...
public class MealsUtil {
    ...
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(null, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500, authUserId()),
            new Meal(null, LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000, authUserId()),
