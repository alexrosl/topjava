            ...
            <form id="filter" method="get" action="meals/filter">
                <div class="row">
                    ...
                    <div class="col-2">
                        ...
                        <input id="endDate" class="form-control" type="date" value="${param.endDate}">
                    </div>
                    <div class="offset-2 col-2">
                        <label for="startTime"><spring:message code="meal.startTime"/></label>
                        <input id="startTime" class="form-control" type="time" value="${param.startTime}">
                    </div>
                    <div class="col-2">
                        <label for="endTime"><spring:message code="meal.endTime"/></label>
                        <input id="endTime" class="form-control" type="time" value="${param.endTime}">
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" minlength="5" maxlength="120" class="form-control" id="description" name="description"
